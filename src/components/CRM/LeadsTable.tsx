        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
          ...
          <Card>
            <CardContent className="flex items-center p-4">
              ...
              <div>
                ...
                <div className="text-sm text-foreground-muted">Contatados</div>
              </div>
            </CardContent>
          </Card>
          ...
          <Card>
            <CardContent className="flex items-center p-4">
              ...
              <div>
                <div className="text-2xl font-bold text-foreground">{stats.disqualified}</div>
                <div className="text-sm text-foreground-muted">Desqualificados</div>
              </div>
            </CardContent>
          </Card>
        </div>
