-- Add new status to enum for completed sales
ALTER TYPE status_negociacao ADD VALUE IF NOT EXISTS 'em_negociacao';
ALTER TYPE status_negociacao ADD VALUE IF NOT EXISTS 'venda_concluida';
